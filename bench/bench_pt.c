...
static bench_Case bench_cases[] = {
    {"pt_from", "single_piece", 100000, 0, setup_single, run_from, teardown_nav, NULL},
    {"pt_seek", "fragmented_10k", 100000, 0, setup_nav, run_seek, teardown_nav, NULL},
    {"pt_seek", "fragmented_100k", 100000, 0, setup_nav_100k, run_seek, teardown_nav, NULL},
    {"pt_seek", "fragmented_1m", 100000, 0, setup_nav_1m, run_seek, teardown_nav, NULL},
    {"pt_locate", "fragmented_10k", 100000, 0, setup_nav, run_locate, teardown_nav, NULL},
    {"pt_locate", "fragmented_100k", 100000, 0, setup_nav_100k, run_locate, teardown_nav, NULL},
    {"pt_locate", "fragmented_1m", 100000, 0, setup_nav_1m, run_locate, teardown_nav, NULL},
    {"pt_advance", "fragmented_10k", 100000, 0, setup_nav, run_advance, teardown_nav, NULL},
    {"pt_advance", "fragmented_100k", 100000, 0, setup_nav_100k, run_advance, teardown_nav, NULL},
    {"pt_advance", "fragmented_1m", 100000, 0, setup_nav_1m, run_advance, teardown_nav, NULL},
    {"pt_read", "fragmented_10k", 100000, 0, setup_nav, run_read, teardown_nav, NULL},
    {"pt_read", "fragmented_100k", 100000, 0, setup_nav_100k, run_read, teardown_nav, NULL},
    {"pt_read", "fragmented_1m", 100000, 0, setup_nav_1m, run_read, teardown_nav, NULL},
    {"pt_next", "fragmented_10k", 20, 0, setup_nav, run_next, teardown_nav, calls_scan},
    {"pt_next", "fragmented_100k", 20, 0, setup_nav_100k, run_next, teardown_nav, calls_scan},
    {"pt_next", "fragmented_1m", 20, 0, setup_nav_1m, run_next, teardown_nav, calls_scan},
    {"pt_prev", "fragmented_10k", 20, 0, setup_nav, run_prev, teardown_nav, calls_scan},
    {"pt_prev", "fragmented_100k", 20, 0, setup_nav_100k, run_prev, teardown_nav, calls_scan},
    {"pt_prev", "fragmented_1m", 20, 0, setup_nav_1m, run_prev, teardown_nav, calls_scan},
    {"pt_edit", "fragmented_10k", 20000, 1, setup_edit, run_edit, teardown_dirty, NULL},
    {"pt_edit", "fragmented_100k", 20000, 1, setup_edit_100k, run_edit, teardown_dirty, NULL},
    {"pt_edit", "fragmented_1m", 20000, 1, setup_edit_1m, run_edit, teardown_dirty, NULL},
    {"pt_edit_commit", "fragmented_10k", 20000, 1, setup_edit_commit, run_edit_commit, teardown_dirty, NULL},
    {"pt_edit_commit", "fragmented_100k", 20000, 1, setup_edit_commit_100k, run_edit_commit, teardown_dirty, NULL},
    {"pt_edit_commit", "fragmented_1m", 20000, 1, setup_edit_commit_1m, run_edit_commit, teardown_dirty, NULL},
    {"pt_insert", "fragmented_10k", 20000, 1, setup_edit, run_insert, teardown_dirty, NULL},
    {"pt_insert", "fragmented_100k", 20000, 1, setup_edit_100k, run_insert, teardown_dirty, NULL},
    {"pt_insert", "fragmented_1m", 20000, 1, setup_edit_1m, run_insert, teardown_dirty, NULL},
    {"pt_append", "fragmented_10k", 20000, 1, setup_edit, run_append, teardown_dirty, NULL},
    {"pt_splice", "fragmented_10k", 20000, 1, setup_edit, run_splice, teardown_dirty, NULL},
    {"pt_splice", "fragmented_100k", 20000, 1, setup_edit_100k, run_splice, teardown_dirty, NULL},
    {"pt_splice", "fragmented_1m", 20000, 1, setup_edit_1m, run_splice, teardown_dirty, NULL},
    {"pt_remove", "fragmented_10k", 20000, 1, setup_edit, run_remove, teardown_dirty, NULL},
    {"pt_remove", "fragmented_100k", 20000, 1, setup_edit_100k, run_remove, teardown_dirty, NULL},
    {"pt_remove", "fragmented_1m", 20000, 1, setup_edit_1m, run_remove, teardown_dirty, NULL},
    {"pt_commit", "fragmented_10k", 1000, 1, setup_dirty, run_commit, teardown_dirty, NULL},
    {"pt_commit", "fragmented_100k", 1000, 1, setup_dirty_100k, run_commit, teardown_dirty, NULL},
    {"pt_commit", "fragmented_1m", 1000, 1, setup_dirty_1m, run_commit, teardown_dirty, NULL},
    {"pt_rollback", "fragmented_10k", 1000, 1, setup_dirty, run_rollback, teardown_dirty, NULL},
    {"pt_rollback", "fragmented_100k", 1000, 1, setup_dirty_100k, run_rollback, teardown_dirty, NULL},
    {"pt_rollback", "fragmented_1m", 1000, 1, setup_dirty_1m, run_rollback, teardown_dirty, NULL},
    {"pt_compact", "edited_10k", 20, 1, setup_compact, run_compact, teardown_nav, NULL},
    {"pt_compact", "edited_100k", 20, 1, setup_compact_100k, run_compact, teardown_nav, NULL},
    {"pt_compact", "edited_1m", 20, 1, setup_compact_1m, run_compact, teardown_nav, NULL},
    {"pt_replay", "editor_script", 20000, 1, setup_replay, run_replay, teardown_dirty, NULL},
};
